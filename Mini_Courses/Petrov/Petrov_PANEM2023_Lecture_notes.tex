...
A configuration of a colored stochastic six vertex model is in \Cref{fig:s6v_height_function}, left.
...
These rules also include holes, which we can treat as particles of the lowest color $-\infty$.

The colored ASEP satisfies the following
\emph{projection properties}:
\begin{enumerate}[$\bullet$]
	\item 
\end{enumerate}
