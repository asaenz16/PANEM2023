...
\begin{remark}
	...
	There is also a strong connection of this setting
	with totally nonnegative triangular Toeplitz matrices
	(for characters of the infinite symmetric group)
	and totally nonnegative
	full Toeplitz matrices 
	(for characters of the infinite-dimensional unitary group),
	see 
	\cite{AESW51}, \cite{Edrei53}, \cite{Boyer1983}.
\end{remark}
